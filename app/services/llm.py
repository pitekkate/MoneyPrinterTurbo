    ...
    try:
        ...
        if llm_provider == "g4f":
            ...
            headers = {
                ...
                "HTTP-Referer": "https://yourdomain.com",  # Opsional, ganti dengan domain Anda
                "X-Title": "MoneyPrinterTurbo",  # Opsional
            }
            ...
            try:
                ...
                raise Exception(f"[{llm_provider}] returned an invalid response format: {str(e)}")
